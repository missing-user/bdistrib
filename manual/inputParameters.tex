...
{\ttfamily geometry\_option\_plasma} = 3: The plasma surface will be the flux surface with normalized poloidal flux
...
{string}
{`'}
{Only when \parlink{geometry\_option\_plasma} is 2.}
...
{string}
{`'}
{Only when \parlink{geometry\_option\_plasma} is 3.}
